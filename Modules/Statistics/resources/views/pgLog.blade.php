...
<div class="container-fluid">
    <div class="row mt-3">
        ...
        <div class="col-lg-4 col-md-4 col-12">
            <a href="javascript:;" data-payment-gateway="razorpay-log" data-entry-for="12" data-offer-name="LA Offer 5" onclick="paymentLogRedirect(this)">
                <div class="card widget-1">
                    <div class="card-body">
                        <div class="widget-content">
                            <div>
    ...
    <div class="row mt-3">
        ...
        <div class="col-lg-4 col-md-4 col-12">
            <a href="javascript:;" data-payment-gateway="razorpay-log" data-entry-for="11" data-offer-name="LA Offer 5" onclick="paymentLogRedirect(this)">
                <div class="card widget-1">
                    <div class="card-body">
                        <div class="widget-content">
                            <div>
